 ...
 * {@code X-Client-Cert}, as injected by nginx with
 * {@code proxy_set_header X-Client-Cert $ssl_client_cert}).
 *
 * <h3>Error path</h3>
...
public class MtlsFilter extends OncePerRequestFilter {
    ...
    public MtlsFilter(MtlsCertificateValidator validator, String certHeader) {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path.startsWith("/v1/oauth/token")
